...
dogsca <- 0 #set to zero to skip the very lengthy GSCA analysis (can read preprepared data)
...
#original file had max LD of .9. Later I tried with reduced value of .75 - seems to give plausible values.
